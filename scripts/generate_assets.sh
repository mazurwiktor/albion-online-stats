...
# - frontend/src/assets/item_category_map.json
# - frontend/src/assets/localization.json
...
echo "Generating frontend/src/assets/item_category_map.json..."
python scripts/item_category_map.py $items_file | python -m json.tool > frontend/src/assets/item_category_map.json

echo "Generating frontend/src/assets/localization.json..."
python scripts/localization.py $localization_file | python -m json.tool > frontend/src/assets/localization.json
