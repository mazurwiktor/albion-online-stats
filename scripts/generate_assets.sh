...
# - pyapp/src/assets/item_category_map.json
# - pyapp/src/assets/localization.json
...
echo "Generating pyapp/src/assets/item_category_map.json..."
python scripts/item_category_map.py $items_file | python -m json.tool > pyapp/src/assets/item_category_map.json

echo "Generating pyapp/src/assets/localization.json..."
python scripts/localization.py $localization_file | python -m json.tool > pyapp/src/assets/localization.json
