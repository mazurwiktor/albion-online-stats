# Helper script used to generate application/src/assets/item_category_map.json
# Args: items.xml generated by ao-id-extractor
# Usage python scripts/item_category_map.py items.xml > application/src/assets/item_category_map.json
