# Helper script used to generate frontend/src/assets/item_category_map.json
# Args: items.xml generated by ao-id-extractor
# Usage python scripts/item_category_map.py items.xml > frontend/src/assets/item_category_map.json
