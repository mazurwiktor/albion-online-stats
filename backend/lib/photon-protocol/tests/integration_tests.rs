...
use photon_protocol::Message;
use photon_protocol::EventData;
use photon_protocol::OperationRequest;
use photon_protocol::OperationResponse;
...
fn test_single_event_message()
{
    ...
    let mut photon = photon_protocol::Photon::new();
