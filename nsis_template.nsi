...
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "[[ib.appname]] installer"
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductVersion" "[[ib.version]]"
VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "Copyright (c) 2020 [[ib.publisher]]"
; This 2020 should be removed but pynsist doesn't support it. 
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "[[ib.appname]] installer"
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "[[ib.version]]"
